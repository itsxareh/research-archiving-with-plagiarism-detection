...
<head>
    ...
    <title> Student - EARIST Repository</title>
                ...
                <div class="col-lg-6">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="index.php"><span>Repository</span></a>
                        </div>
                        <div class="login-form">
                            ...
                            <?php
                                  if(isset($_GET['student_no'])){
                                    ...
                                    $row = $db->student_profile_by_sno($student_no);

                                  ?>
                                <input type="hidden" name="studentID" value="<?=$student_no?>" required>
