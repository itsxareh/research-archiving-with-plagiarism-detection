                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Student Archive List</li>
                                </ol>
                            </div>
                        </div>
                    </div>
...
<br><br><br>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="view_student_info.php?studID=<?= $result['studID'] ?>" class="btn btn-primary"><i class="ti-eye" title="View Information"></i></a>
                </td>
            </tr>
            <?php
            }
...
// $("#studentsection").show();
    ...
    <script src="js/lib/jquery.scroller.min.js"></script>
