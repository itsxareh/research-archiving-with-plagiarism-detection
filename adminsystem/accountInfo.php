...
<div class="basic-info">
    <form id="image-upload-form" method="POST" enctype="multipart/form-data">
        <label class="change-picture" for="upload-image">
            <div class="profile">
                <img alt="" id="myImage" title="" class="profile-picture" src="<?= isset($data['admin_profile_picture']) ? $data['admin_profile_picture'] : '../images/default-profile.svg' ?>" data-original-title="Usuario">
            </div>
