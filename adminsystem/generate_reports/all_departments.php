...
if (!hasPermit($permissions, 'department_view')) {
...
$student_list = $db->showDepartments();
ob_start();
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>EARIST Repository - Department's List</title>
...
<body>
    <div class="header">
        <h1>EARIST Repository - Department's List</h1>
        ...
        <table>
            ...
            if (!empty($student_list)){
                foreach ($student_list as $student){
                    $status_class = $student['department_status'] === 'Active' ? 'status-approved' : 'status-not-approved';
            ?>
                <tr>
                    <td><?php echo htmlspecialchars($student['dept_code']); ?></td>
                    <td><?php echo htmlspecialchars($student['name']); ?></td>
                    <td class="text-center <?php echo $status_class; ?>"><?php echo htmlspecialchars($student['department_status']); ?></td>
                </tr>
            <?php 
                }
            } else {
