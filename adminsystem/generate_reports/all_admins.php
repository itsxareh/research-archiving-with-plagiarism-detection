...
if (!hasPermit($permissions, 'user_view')) {
...
$admin_list = $db->SELECT_ALL_AdminsData();
ob_start();
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>EARIST Repository - Admin's List</title>
...
<body>
    <div class="header">
        <h1>EARIST Repository - Admin's List</h1>
        ...
        <table>
            ...
            if (!empty($admin_list)){
                foreach ($admin_list as $admin){
                    $status_class = $admin['admin_status'] === 'Active' ? 'status-approved' : 'status-not-approved';
            ?>
                <tr>
