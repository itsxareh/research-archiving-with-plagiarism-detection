...
include 'helper.php';
if ($departmentId != 0){
    $student_list = $db->Archive_Research_Views_BasedOn_Department($departmentId);
} else {
    $student_list = $db->Archive_Research_Views_BasedOn_Departments();
}
ob_start();
?>
<!DOCTYPE html>
...
<head>
    ...
    <title><?php echo htmlspecialchars($departmentId != 0 ? $db->getDepartmentById($departmentId)['name'] : 'All Departments'); ?> - Research Views/Department</title>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th class="text-center" style="width: 30%">Views Count</th>
                </tr>
            </thead>
            <tbody>
            <?php 
