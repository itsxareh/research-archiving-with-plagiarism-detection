                            ...
                            <tr>
                                ...
                                <td class="list-td" style="text-align: center;">
                                    ...
                                    <input 
                                        ...
                                        <?php if (!hasPermission($permissions, 'user_status') || $result['adminID'] == 1): ?>
                                            disabled
                                        <?php endif; ?>
                                        >
                                        ...
                                        <div class="dropdown-action" id="dropdown_<?= $result['adminID'] ?>" role="action" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                                            <div role="none">
                                                ...
                                                <?php if (hasPermission($permissions, 'user_delete')): ?>
                                                    <a onclick="confirmDelete(<?= $result['adminID'] ?>)" href="#" data-toggle="delete-modal" data-target="#delete_modelId_<?= $result['adminID'] ?>" class="dropdown-action-item">Delete</a>
                                                <?php endif; ?>
                                                <?php if (hasPermission($permissions, 'user_logs')): ?>
                                                    <a target="_blank" href="generate_reports/generate_pdf.php?generate_report_for=admin_activity_logs&adminID=<?= $result['adminID'] ?>" class="dropdown-action-item">
                                                        View activity logs
                                                    </a>
                                                <?php endif; ?>
                                            </div>
